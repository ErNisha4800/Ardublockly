...
/** ESP32 for the Dev Module*/
Blockly.Arduino.Boards.profiles.esp32_dev_module = {
  name: 'ESP32 Dev Module',
  description: 'ESP32 Dev Module',
  compilerFlag: 'esp32:esp32:esp32',
  analogPins: [['Analog-GPIO12', '12'],
			   ['Analog-GPIO13', '13'], ['Analog-GPIO14', '14'], ['Analog-GPIO15', '15'],
			   ['Analog-GPIO25', '25'], ['Analog-GPIO26', '26'], ['Analog-GPIO27', '27'],
			   ['Analog-GPIO32', '32'], ['Analog-GPIO33', '33'], ['Analog-GPIO34', '34'],
			   ['Analog-GPIO35', '35'], ['Analog-GPIO36', '36'], ['Analog-GPIO39', '39']],
   digitalPins: [['GPIO1', '1'],
               ['GPIO2', '2'], ['GPIO3', '3'], ['GPIO4', '4'],  ['GPIO5', '5'] ,
            ['GPIO12', '12'] ,
            ['GPIO13', '13'], ['GPIO14', '14'], ['GPIO15', '15'], ['GPIO16', '16'],
			['GPIO17', '17'], ['GPIO18', '18'], ['GPIO19', '19'], ['GPIO21', '21'],	['GPIO22', '22'],
			['GPIO23', '23'], ['GPIO25', '25'], ['GPIO26', '26'], ['GPIO27', '27'], 
            ['GPIO32', '32'], ['GPIO33', '33'], ['GPIO34 (INPUT ONLY)', '34'],
			['GPIO35 (INPUT ONLY)', '35'], ['GPIO36 (INPUT ONLY)', '36'], ['GPIO39 (INPUT ONLY)', '39']
], 
  pwmPins:  [
          ['GPIO1', '1'],['GPIO2', '2'], ['GPIO3', '3'], ['GPIO4', '4'],  ['GPIO5', '5'] ,
            ['GPIO13', '13'], ['GPIO14', '14'], ['GPIO15', '15'], ['GPIO16', '16'],
			['GPIO17', '17'], ['GPIO18', '18'], ['GPIO19', '19'], ['GPIO21', '21'],	['GPIO22', '22'],
			['GPIO23', '23'], ['GPIO25', '25'], ['GPIO26', '26'], ['GPIO27', '27'], 
            ['GPIO32', '32'], ['GPIO33', '33']], 
  serial: [['UART0', 'Serial'], ['UART2', 'Serial2']],
  serialPins: { Serial: [['UART0-RX-GPIO3', '3'], ['UART0-TX-GPIO1', '1']],
                Serial2: [['UART2-RX-GPIO16', '16'], ['UART2-TX-GPIO17', '17']]},
  serialSpeed: Blockly.Arduino.Boards.profiles.uno.serialSpeed,
  spi: [['SPI', 'SPI']],
  spiPins: { SPI: [['MOSI-GPIO23', '23'], ['MISO-GPIO19', '19'], ['CLK-GPIO18', '18']] },
  spiClockDivide: Blockly.Arduino.Boards.profiles.uno.spiClockDivide,
  i2c: [['I2C', 'Wire']],
  i2cPins: [['SDA-GPIO21', '21'], ['SCL-GPIO22', '22']],
  i2cSpeed: Blockly.Arduino.Boards.profiles.uno.i2cSpeed,
  builtinLed: [['BUILTIN_LED_GPIO2', '2']],
  interrupt: [['GPIO5', '5'], ['GPIO13', '13'],
              ['GPIO14', '14'], ['GPIO15', '15'], ['GPIO16', '16'], ['GPIO17', '17'],
              ['GPIO18', '18'], ['GPIO19', '19'], ['GPIO21', '21'], ['GPIO22', '22'], 
              ['GPIO23', '23'], ['GPIO25', '25'], ['GPIO26', '26'], ['GPIO27', '27'], 
              ['GPIO32', '32'], ['GPIO33', '33']],
  touch: [['GPIO12', '12'], ['GPIO13', '13'],
         ['GPIO14', '14'], ['GPIO15', '15'], ['GPIO27', '27'], ['GPIO32', '32'], ['GPIO33', '33']],
  rtcGPIOs: [['GPIO12', '12'], ['GPIO13', '13'],
         ['GPIO14', '14'], ['GPIO15', '15'], ['GPIO25', '25'], ['GPIO26', '26'], ['GPIO27', '27'], ['GPIO32', '32'], ['GPIO33', '33']]
};

/** ESP32 for the  lilygo_ttgo*/
Blockly.Arduino.Boards.profiles.esp32_lilygo_ttgo = {
  name: 'ESP32 Lilygo TTGO',
  description: 'ESP32 Lilygo TTGO',
  compilerFlag: 'esp32:esp32:esp32',
  analogPins: [['Analog-GPIO2', '2'],
			   ['Analog-GPIO12', '12'], ['Analog-GPIO13', '13'], ['Analog-GPIO15', '15'],
			   ['Analog-GPIO25', '25'], ['Analog-GPIO26', '26'], ['Analog-GPIO27', '27'],
			   ['Analog-GPIO32', '32'], ['Analog-GPIO33', '33'], ['Analog-GPIO36', '36'],
			   ['Analog-GPIO39', '39']],
  digitalPins: [['GPIO2', '2'],
    
			   ['GPIO12', '12'], ['GPIO13', '13'], ['GPIO15', '15'],
			   ['GPIO25', '25'], ['GPIO26', '26'], ['GPIO27', '27'],
			   ['GPIO32', '32'], ['GPIO33', '33'], ['GPIO36', '36'],
  ...
  serialSpeed: Blockly.Arduino.Boards.profiles.uno.serialSpeed,
  spi: [['SPI', 'SPI']],
  spiPins: { SPI: [['MOSI-GPIO26', '26'], ['MISO-GPIO27', '27'], ['CLK-GPIO25', '25']] },
  spiClockDivide: Blockly.Arduino.Boards.profiles.uno.spiClockDivide,
  i2c: [['I2C', 'Wire']],
  i2cPins: [['SDA-GPIO21', '21'], ['SCL-GPIO22', '22']],
  i2cSpeed: Blockly.Arduino.Boards.profiles.uno.i2cSpeed,
  builtinLed: [['BUILTIN_LED_GPIO1', '1']],
  interrupt: [['GPIO2', '2'],
			 ['GPIO12', '12'], ['GPIO13', '13'], ['GPIO15', '15'],
			 ['GPIO25', '25'], ['GPIO26', '26'], ['GPIO27', '27'],
			 ['GPIO32', '32'], ['GPIO33', '33'], ['GPIO36', '36'],
...
Blockly.Arduino.Boards.selected = Blockly.Arduino.Boards.profiles.esp32_dev_module;
